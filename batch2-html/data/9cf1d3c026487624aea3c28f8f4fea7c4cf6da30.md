...
- Location: tests/streaming2-e2e.spec.js:288:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_RESET at https://detailedvehiclehistory.com/
Call log:
  - navigating to "https://detailedvehiclehistory.com/", waiting until "load"
