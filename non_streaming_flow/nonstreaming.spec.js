...
test.describe('Non-Streaming Main Test Suite', () => {
  test('TC_NS_01_Non_Streaming_17_Character_VIN_Validation', async ({ page }) => {
  ...
  test('TC_NS_02_Non_Streaming_Classic_VIN_Validation', async ({ page }) => {
  ...
  test('TC_NS_03_Non_Streaming_EU_VIN_Confirmation_Validation', async ({ page }) => {
  ...
  test('TC_NS_04_Non_Streaming_Revisit_Banner_Validation', async ({ page }) => {
  ...
  test('TC_NS_05_Non_Streaming_Revisit_Banner_Sticker_Validation', async ({ page }) => {
